...
public class selecao_de_modo extends JFrame implements ActionListener{
	...
	private PanelDeJogo panelDeJuego;
	...
	public selecao_de_modo(Principal Pprincipal,PanelDeJogo juego) {
		iniciar();
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == boton1) {
			if(combo1.getSelectedIndex() == 0 || combo2.getSelectedIndex() == 0) {
				...
				panelDeJuego.trocar(combo1.getSelectedIndex(), combo2.getSelectedIndex());
				dispose();
			}
		}else {
			dispose();
